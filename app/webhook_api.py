...
@router.post("/v1/webhooks/{connector_id}/{endpoint_key}/{webhook_id}", responses={422: EVENT_TYPE_422_RESPONSE})
...
@router.post("/webhooks/vicidial/call-result/{webhook_id}", responses={422: EVENT_TYPE_422_RESPONSE})
...
@router.post("/v1/crm/delivery-results/{webhook_id}", responses={422: EVENT_TYPE_422_RESPONSE})
